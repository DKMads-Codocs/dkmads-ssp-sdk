...
/// (canonical source). Injected into creative web views at document start.
/// Keep in sync with the shared file when the MRAID bridge changes.
enum DKMadsMraidScript {
